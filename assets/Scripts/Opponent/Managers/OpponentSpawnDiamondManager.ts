...
@ccclass('OpponentSpawnDiamondManager')
export class OpponentSpawnDiamondManager extends Component {
    @property({ type: [Prefab] })
    private diamondPrefab: Prefab[] = [];

    @property(OpponentSpawnEnemyManager)
    private spawnEnemyManager: OpponentSpawnEnemyManager;
