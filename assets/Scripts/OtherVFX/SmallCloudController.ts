...
@ccclass('SmallCloudController')
export class SmallCloudController extends Component {
    private leftXMin: number = -250;
    private leftXMax: number = -255;

    private rightXMin: number = 250;
    private rightXMax: number = 255;

    private minMoveDuration: number = 60;
    private maxMoveDuration: number = 90;
